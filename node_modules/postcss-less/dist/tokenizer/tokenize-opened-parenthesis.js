...
function tokenizeOpenedParenthesis(state) {
    ...
    if (prevTokenCssPart === 'url' && state.nextSymbolCode !== _globals.singleQuote && state.nextSymbolCode !== _globals.doubleQuote && state.nextSymbolCode !== _globals.space && state.nextSymbolCode !== _globals.newline && state.nextSymbolCode !== _globals.tab && state.nextSymbolCode !== _globals.feed && state.nextSymbolCode !== _globals.carriageReturn) {
