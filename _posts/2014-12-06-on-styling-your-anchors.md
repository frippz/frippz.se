...
{% include image.html url="/images/focus-outline-chrome.png" width="195" height="195" caption="Google Chrome (OS X 10.8)" %}
{% include image.html url="/images/focus-outline-firefox.png" width="195" height="195" caption="Mozilla Firefox (OS X 10.8)" %}
{% include image.html url="/images/focus-outline-ie10.png" width="195" height="195" caption="Internet Explorer 10 (Win 8)" %}
{% include image.html url="/images/focus-outline-ie8.png" width="195" height="195" caption="Internet Explorer 8 (Win XP)" %}
